  ...
  try {
    ...
    const intentResponse = await generateText({
      ...
      system: `You are a Wonderland assistant.
        ...
        - "account_creation": If the user is asking to create, update, or manage an account         - "general_query": If the user is asking a general question about Wonderland or unrelated topics.
